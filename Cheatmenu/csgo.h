...
namespace offsets
{
	...
	constexpr ptrdiff_t dwClientState = 0x589FCC;
	...
	constexpr ptrdiff_t dwEntityList = 0x4DC178C;
	constexpr ptrdiff_t dwForceAttack = 0x31F1D14;
	constexpr ptrdiff_t dwForceAttack2 = 0x31F1D20;
	constexpr ptrdiff_t dwForceBackward = 0x31F1CA4;
	constexpr ptrdiff_t dwForceForward = 0x31F1C98;
	constexpr ptrdiff_t dwForceJump = 0x526B5A0;
	constexpr ptrdiff_t dwForceLeft = 0x31F1CF0;
	constexpr ptrdiff_t dwForceRight = 0x31F1CE4;
	constexpr ptrdiff_t dwGameDir = 0x628780;
	constexpr ptrdiff_t dwGameRulesProxy = 0x52DE87C;
	constexpr ptrdiff_t dwGetAllClasses = 0xDCFAA4;
	constexpr ptrdiff_t dwGlobalVars = 0x589CD0;
	constexpr ptrdiff_t dwGlowObjectManager = 0x5309C90;
	constexpr ptrdiff_t dwInput = 0x5212D50;
	constexpr ptrdiff_t dwInterfaceLinkList = 0x957AA4;
	constexpr ptrdiff_t dwLocalPlayer = 0xDA746C;
	constexpr ptrdiff_t dwMouseEnable = 0xDACFB8;
	constexpr ptrdiff_t dwMouseEnablePtr = 0xDACF88;
	constexpr ptrdiff_t dwPlayerResource = 0x31F0030;
	constexpr ptrdiff_t dwRadarBase = 0x51F6504;
	constexpr ptrdiff_t dwSensitivity = 0xDACE54;
	constexpr ptrdiff_t dwSensitivityPtr = 0xDACE28;
	constexpr ptrdiff_t dwSetClanTag = 0x8A290;
	constexpr ptrdiff_t dwViewMatrix = 0x4DB30A4;
	constexpr ptrdiff_t dwWeaponTable = 0x5213814;
	constexpr ptrdiff_t dwWeaponTableIndex = 0x326C;
	constexpr ptrdiff_t dwYawPtr = 0xDACC18;
	constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xDB1EB8;
	constexpr ptrdiff_t dwbSendPackets = 0xD9342;
	constexpr ptrdiff_t dwppDirect3DDevice9 = 0xA7050;
	constexpr ptrdiff_t m_pStudioHdr = 0x2950;
	constexpr ptrdiff_t m_yawClassPtr = 0xDACC18;
	constexpr ptrdiff_t m_pitchClassPtr = 0x51F67A0;
	...
	constexpr ptrdiff_t model_ambient_min = 0x58D044;
	constexpr ptrdiff_t set_abs_angles = 0x1E3F70;
	constexpr ptrdiff_t set_abs_origin = 0x1E3DB0;
	constexpr ptrdiff_t is_c4_owner = 0x3C1090;
	constexpr ptrdiff_t force_update_spectator_glow = 0x3B412A;
	constexpr ptrdiff_t anim_overlays = 0x2990;
	constexpr ptrdiff_t m_flSpawnTime = 0x103C0;
	constexpr ptrdiff_t find_hud_element = 0x26C13080;
